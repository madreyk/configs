...
xkb_symbols "winkeys" {
    ...
    key <TLDE> {[Cyrillic_zhe, Cyrillic_ZHE, grave,    asciitilde]};
    key <AE01> {        [         1,    exclam          ]       };
    key <AE02> {        [         2,    at              ]       };
    ...
    key <AE12> {        [     equal,    plus            ]       };
    key <AB08> { [    comma,    less, Cyrillic_be        ] };
    key <AB09> { [ period,   greater, Cyrillic_yu        ] };
    key <AB10> { [     slash,    question                ] };
    key <AC10> { [       colon, semicolonm, Cyrillic_zhe ] };
    key <AC11> { [      Cyrillic_e, Cyrillic_E, quotedbl, apostrophe ] };
    key <AD11> { [ Cyrillic_che, Cyrillic_CHE, bracketleft,  braceleft ] };
    key <AD12> { [ Cyrillic_be, Cyrillic_BE, bracketright, braceright              ] };
    key <BKSL> { [ Cyrillic_yu, Cyrillic_YU, backslash, bar  ] 	};
};
...
xkb_symbols "common" {
    ...
    key <AC10> { [       semicolon, colonm, Cyrillic_zhe ] };
    key <AC11> { [      Cyrillic_e, apostrophe, quotedbl ] };
